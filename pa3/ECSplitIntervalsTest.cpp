...
bool Test3(){
	...
	vector<pair<int,int>> intervals = {{1,5},{6,10},{11,15},{16,20}};
	const vector<int> vals_to_remove = {1,2,3,8,7,6,13,14,15,18,19,20};
	
	vector<pair<int,int>> expected = {{4,5},{9,10},{11,12},{16,17}};
	splitIntervals(intervals, vals_to_remove);
	cout<<"output:          ";
	printIntervals(intervals);
	cout<<"expected output: ";
